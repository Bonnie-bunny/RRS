...
public class YelpAPI {
    ...
    private static final String CLIENT_ID = "-hexvjXtmS2v_hvu0bBoEg";
    private static final String CLIENT_SECRET = "T4gNmlQL4olydFRHwWbF44P9xzGQLSNN7xRR0EIBlPkMk2rKnVqTk8JhvWkAC7JE";
    ...
    // creates and sneds a request to the Search API by term and location
    ...
    private void queryAPI(double lat, double lon){
    	List<Item> restaurants = search(lat, lon, null);
    ...
    private List<Item> getItemList(JSONArray array) throws JSONException{
    	...
    	for (int i = 0; i < array.length(); i++) {
    		...
    		for (int j = 0; j < jsonArray.length(); j++) {
    			...
    			categories.add(subObject.getString("title"));
    		}
